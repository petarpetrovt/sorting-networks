...
```
#### Parameters
<a name='SortingNetworks-SNBoseNelson-SortDescendingBranchless(sbyte_int)-p0'></a>
`p0` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')  
the reference to the first element of the collection  
  
<a name='SortingNetworks-SNBoseNelson-SortDescendingBranchless(sbyte_int)-length'></a>
