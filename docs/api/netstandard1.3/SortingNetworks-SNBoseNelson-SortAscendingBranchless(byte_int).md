...
```
#### Parameters
<a name='SortingNetworks-SNBoseNelson-SortAscendingBranchless(byte_int)-p0'></a>
`p0` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')  
the reference to the first element of the collection  
  
<a name='SortingNetworks-SNBoseNelson-SortAscendingBranchless(byte_int)-length'></a>
