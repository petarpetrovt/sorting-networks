...
```
#### Parameters
<a name='SortingNetworks-SNBestKnown-SortAscendingBranchless(ushort_int)-p0'></a>
`p0` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')  
the reference to the first element of the collection  
  
<a name='SortingNetworks-SNBestKnown-SortAscendingBranchless(ushort_int)-length'></a>
