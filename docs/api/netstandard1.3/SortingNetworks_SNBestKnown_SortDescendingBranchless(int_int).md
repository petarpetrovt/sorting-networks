...
```
#### Parameters
<a name='SortingNetworks_SNBestKnown_SortDescendingBranchless(int_int)_p0'></a>
`p0` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')  
the reference to the first element of the collection
  
<a name='SortingNetworks_SNBestKnown_SortDescendingBranchless(int_int)_length'></a>
