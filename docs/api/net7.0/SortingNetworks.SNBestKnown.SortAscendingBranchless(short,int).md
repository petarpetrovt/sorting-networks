...
<a name='SortingNetworks.SNBestKnown.SortAscendingBranchless(short,int).p0'></a>

`p0` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

the reference to the first element of the collection

<a name='SortingNetworks.SNBestKnown.SortAscendingBranchless(short,int).length'></a>
