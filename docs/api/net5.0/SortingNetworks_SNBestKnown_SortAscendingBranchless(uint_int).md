...
```
#### Parameters
<a name='SortingNetworks_SNBestKnown_SortAscendingBranchless(uint_int)_p0'></a>
`p0` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')  
the reference to the first element of the collection
  
<a name='SortingNetworks_SNBestKnown_SortAscendingBranchless(uint_int)_length'></a>
