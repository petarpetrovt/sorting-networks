...
## SNBoseNelsonGenerated.Sort4Descending&lt;T&gt;(T) Method
...
```
#### Type parameters
<a name='SortingNetworks-SNBoseNelsonGenerated-Sort4Descending-T-(T)-T'></a>
`T`  
The type of the elements of the collection.  
  
#### Parameters
<a name='SortingNetworks-SNBoseNelsonGenerated-Sort4Descending-T-(T)-p0'></a>
`p0` [T](#SortingNetworks-SNBoseNelsonGenerated-Sort4Descending-T-(T)-T 'SortingNetworks.SNBoseNelsonGenerated.Sort4Descending&lt;T&gt;(T).T')  
